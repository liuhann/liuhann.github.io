...
(function() {
  var $, $$, PHI, activate, addPalette, arrow, backslash, bang, box, bulb, curTool, currentHover, currentView, deg2rad, diamond, diamondbulb, divs, double, drawbox, eqtriangle, extend, fork, getAngle, golden, goldener, halve, hook, hoverbox, i, intersect, isoceles, k, kay, keymap, latch, ltriangle, mtriangle, n, ngon, normal, origTool, qswirl, rad2deg, ref, refreshHover, rightangle, rtriangle, rtriangleh, sbend, scrawl, scrawlFromLine, scrawlProto, screenToSVG, slash, star, tee, toolState, ubend, v, wrapFunc, wtriangle, zbend;

  $ = document.querySelector.bind(document);

  $$ = document.querySelectorAll.bind(document);

  deg2rad = function(sai) {
    return sai * Math.PI / 180;
  };

  rad2deg = function(sai) {
    return sai / Math.PI * 180;
  };
